  ...
  return (
    <>
      ...
      >
        ...
        >
          <p style={styles.p}>
            Welcome to the Mandate page of Kafanchan Municipal Authority (KMA).
            At KMA, our mandate is to work tirelessly towards the betterment of
            the municipality and its residents. We are dedicated to creating a
          ...
          <p style={styles.p}>
            We are determined to provide efficient and responsive services to
            the residents of Kafanchan. By streamlining administrative
            processes, embracing technology, and ensuring transparency, we aim
            to deliver high-quality services that meet the needs and
          ...
          <p style={styles.p}>
            ...
            support systems, and initiatives that empower marginalized groups
          ...
          <p style={styles.p}>
            ...
            to create an enabling environment for businesses to flourish,
            attract investments, and generate employment opportunities that
            contribute to the overall economic growth of the municipality.
          </p>
          ...
          <p style={styles.p}>
            ...
            website to learn more about our initiatives, projects, and how you
            can actively participate in shaping the future of our municipality.
          </p>
